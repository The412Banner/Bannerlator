...
>
> **Status:** GPU-path risk retired; winewayland wcp BUILT+verified; app native foundation BUILT+APK-green. Only M4 (SurfaceView Activity + launch wiring) remains — no feasibility unknowns left. Nothing merged; X11 untouched.
