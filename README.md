...
| **Version** | Bannerlator **V 3.0.2** — built from Star **marcescence** (`versionName 3.0.2`, `versionCode 76`) |
...
- **Steam save sync & achievements — use at your own risk.** Steam cloud-save sync and achievements run through **third-party systems** (Valve's Steam and Goldberg), exactly like the store sign-ins. Cloud-save sync depends on your connection — an **unstable or dropped internet connection or network can leave a save un-synced or out of date**. It is **your responsibility** to ensure a proper, stable connection and to sync when required; verify a save has synced before relying on it across devices.
