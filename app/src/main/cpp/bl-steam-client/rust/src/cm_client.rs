...
use crate::library_store::BlLibraryStore;
use crate::pb::ccloud::{
...
pub struct CMClientCore {
    ...
    library: BlLibraryStore,
    tickets: BlTicketCache,
...
impl Default for CMClientCore {
    fn default() -> Self {
        Self {
            ...
            library: BlLibraryStore::default(),
            tickets: BlTicketCache::default(),
...
impl CMClientCore {
    ...
    pub fn library(&self) -> &BlLibraryStore {
        &self.library
    }

    pub fn tickets(&self) -> &BlTicketCache {
        &self.tickets
    }
