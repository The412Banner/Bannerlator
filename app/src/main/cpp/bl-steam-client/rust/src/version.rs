...
pub const VERSION: Version = Version {
    major: parse_i32_or(option_env!("BL_STEAM_CLIENT_VERSION_MAJOR"), 0),
    minor: parse_i32_or(option_env!("BL_STEAM_CLIENT_VERSION_MINOR"), 1),
    patch: parse_i32_or(option_env!("BL_STEAM_CLIENT_VERSION_PATCH"), 0),
    string: str_or(option_env!("BL_STEAM_CLIENT_VERSION_STRING"), "0.1.0"),
};
