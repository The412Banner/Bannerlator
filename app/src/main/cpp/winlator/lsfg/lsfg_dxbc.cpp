// DXBC -> SPIR-V translation for the base LSFG shader chain, using DXVK's vendored
// dxbc subset (thirdparty/dxbc, zlib licence). Follows lsfg-vk's trans.cpp encounter-
// order binding renumber. Ported from WinNative PR #697 (GPL-3.0-or-later).
#include "lsfg_dxbc.h"
