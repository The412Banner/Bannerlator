// IMPORTANT: the package path below is hard-bound to native JNI lookup (jni.rs).
// Do NOT move this file or rename the package without updating native code.
package com.winlator.star.store.blsteam

/**
 * Callback surface for [BlConnection]. Implementations receive lifecycle and
 ...
 *   5 = HmacMismatch
 */
interface BlConnectionObserver {
