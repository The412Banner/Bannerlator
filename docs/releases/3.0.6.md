...
2. **Set the container's Frame Generation engine to LSFG Native** (container settings, or per game in the shortcut settings). The container must use the **Vulkan** renderer.
