...
> **PII note:** the runtime log carries the device owner's own Steam account (email `davidroethlein@***`, steamID `<owner-steamid64>`). It is the user's own data; quoted values are redacted here.
